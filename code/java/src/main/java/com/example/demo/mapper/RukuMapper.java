...
public interface RukuMapper extends BaseMapper<Ruku> {
    @Select("select r.id,product_id,riqi,warehouse,staff,product_name,pinhao,spec,attribute,unit,pihao,r.num,remarks,state,product_date from ruku r left join product p " +
    ...
    @Select("select r.id,product_id,riqi,warehouse,staff,product_name,pinhao,spec,attribute,unit,pihao,r.num,remarks,state,product_date from ruku r left join product " +
