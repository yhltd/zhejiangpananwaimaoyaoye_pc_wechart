...
public interface SaleMapper extends BaseMapper<Sale> {
    @Select("select sa.id,sa.riqi,customer_id,sh_staff,pick,product_id,sa.num,xiaoji,sa.remarks,type,customer,address,customer_num,area,leibie,salesman,product_name,spec,pinhao,attribute,unit,sa.price,p.pinyin,sa.sale_state,sa.sale_type,warehouse from (select s.id,s.riqi,customer_id,sh_staff,pick,wuliu_order,product_id,pihao,num,xiaoji,s.remarks,warehouse,type,express,customer,address,customer_num,area,leibie,salesman,pinyin,fahuo,s.price,sale_state,sale_type,chuku_insert from sale s left join customerInfo c on s.customer_id=c.id) as sa left join product p on sa.product_id=p.id where sa.chuku_insert != '1' order by sa.id desc,customer,sale_type")
    List<Sale> getList();

    @Select("select sa.id,sa.riqi,customer_id,sh_staff,pick,product_id,sa.num,xiaoji,sa.remarks,type,customer,address,customer_num,area,leibie,salesman,product_name,spec,pinhao,attribute,unit,sa.price,p.pinyin,sa.sale_state,sa.sale_type,warehouse from (select s.id,s.riqi,customer_id,sh_staff,pick,wuliu_order,product_id,pihao,num,xiaoji,s.remarks,warehouse,type,express,customer,address,customer_num,area,leibie,salesman,pinyin,fahuo,s.price,sale_state,sale_type,chuku_insert from sale s left join customerInfo c on s.customer_id=c.id) as sa left join product p on sa.product_id=p.id where sa.chuku_insert != '1' and sa.riqi = #{riqi} and sa.customer = #{customer} and sa.salesman = #{salesman} and sale_state = #{type} order by sa.id desc,customer,sale_type")
    List<Sale> getList_kanban(String riqi,String customer,String salesman,String type);

    @Select("select sa.id,sa.riqi,customer_id,sh_staff,pick,product_id,sa.num,xiaoji,sa.remarks,type,customer,address,customer_num,area,leibie,salesman,product_name,spec,pinhao,attribute,unit,sa.price,p.pinyin,sa.sale_state,sa.sale_type,warehouse from (select s.id,s.riqi,customer_id,sh_staff,pick,wuliu_order,product_id,pihao,num,xiaoji,s.remarks,warehouse,type,express,customer,address,customer_num,area,leibie,salesman,pinyin,fahuo,s.price,sale_state,sale_type,chuku_insert from sale s left join customerInfo c on s.customer_id=c.id) as sa left join product p on sa.product_id=p.id where sa.sale_state ='审核中' and sa.chuku_insert != '1' order by sa.id desc,customer,sale_type")
    List<Sale> getList_shenhezhong();

    @Select("select sa.id,sa.riqi,customer_id,sh_staff,pick,product_id,sa.num,xiaoji,sa.remarks,type,customer,address,customer_num,area,leibie,salesman,product_name,spec,pinhao,attribute,unit,sa.price,p.pinyin,sa.sale_state,sa.sale_type,warehouse from (select s.id,s.riqi,customer_id,sh_staff,pick,wuliu_order,product_id,pihao,num,xiaoji,s.remarks,warehouse,type,express,customer,address,customer_num,area,leibie,salesman,pinyin,fahuo,s.price,sale_state,sale_type,chuku_insert from sale s left join customerInfo c on s.customer_id=c.id) as sa left join product p on sa.product_id=p.id where sa.sale_state ='审核通过' and sa.chuku_insert != '1' order by sa.id desc,customer,sale_type")
    List<Sale> getList_tongguo();

    @Select("select sa.id,sa.riqi,customer_id,sh_staff,pick,product_id,sa.num,xiaoji,sa.remarks,type,customer,address,customer_num,area,leibie,salesman,product_name,spec,pinhao,attribute,unit,sa.price,p.pinyin,sa.sale_state,sa.sale_type,warehouse from (select s.id,s.riqi,customer_id,sh_staff,pick,wuliu_order,product_id,pihao,num,xiaoji,s.remarks,warehouse,type,express,customer,address,customer_num,area,leibie,salesman,pinyin,fahuo,s.price,sale_state,sale_type,chuku_insert from sale s left join customerInfo c on s.customer_id=c.id) as sa left join product p on sa.product_id=p.id where sa.sale_state ='审核未通过' and sa.chuku_insert != '1' order by sa.id desc,customer,sale_type")
    List<Sale> getList_weitongguo();

    @Select("select sa.id,sa.riqi,customer_id,sh_staff,pick,product_id,sa.num,xiaoji,sa.remarks,type,customer,address,customer_num,area,leibie,salesman,product_name,spec,pinhao,attribute,unit,sa.price,p.pinyin,sa.sale_state,sa.sale_type,warehouse from (select s.id,s.riqi,customer_id,sh_staff,pick,wuliu_order,product_id,pihao,num,xiaoji,s.remarks,warehouse,type,express,customer,address,customer_num,area,leibie,salesman,pinyin,fahuo,s.price,sale_state,sale_type,chuku_insert from sale s left join customerInfo c on s.customer_id=c.id) as sa left join product p on sa.product_id=p.id where salesman=#{name} and sa.chuku_insert != '1' order by sa.id desc,customer,sale_type")
    ...
    @Select("select sa.id,sa.riqi,customer_id,sh_staff,pick,product_id,sa.num,xiaoji,sa.remarks,type,customer,address,customer_num,area,leibie,salesman,product_name,spec,pinhao,attribute,unit,sa.price,p.pinyin,sa.sale_state,sa.sale_type,warehouse from (select s.id,s.riqi,customer_id,sh_staff,pick,wuliu_order,product_id,pihao,num,xiaoji,s.remarks,warehouse,type,express,customer,address,customer_num,area,leibie,salesman,pinyin,fahuo,s.price,sale_state,sale_type,chuku_insert from sale s left join customerInfo c on s.customer_id=c.id) as sa left join product p on sa.product_id=p.id where salesman=#{name} and sa.chuku_insert != '1' and sa.sale_state ='审核通过' order by sa.id desc,customer,sale_type")
    List<Sale> getListByName_tongguo(String name);

    @Select("select sa.id,sa.riqi,customer_id,sh_staff,pick,product_id,sa.num,xiaoji,sa.remarks,type,customer,address,customer_num,area,leibie,salesman,product_name,spec,pinhao,attribute,unit,sa.price,p.pinyin,sa.sale_state,sa.sale_type,warehouse from (select s.id,s.riqi,customer_id,sh_staff,pick,wuliu_order,product_id,pihao,num,xiaoji,s.remarks,warehouse,type,express,customer,address,customer_num,area,leibie,salesman,pinyin,fahuo,s.price,sale_state,sale_type,chuku_insert from sale s left join customerInfo c on s.customer_id=c.id) as sa left join product p on sa.product_id=p.id where salesman=#{name} and sa.chuku_insert != '1' and sa.sale_state ='审核未通过' order by sa.id desc,customer,sale_type")
    ...
    @Select("select sa.id,sa.riqi,customer_id,sh_staff,pick,product_id,sa.num,xiaoji,sa.remarks,type,customer,address,customer_num,area,leibie,salesman,product_name,spec,pinhao,attribute,unit,sa.price,p.pinyin,sa.sale_state,sa.sale_type,warehouse from (select s.id,s.riqi,customer_id,sh_staff,pick,wuliu_order,product_id,pihao,num,xiaoji,s.remarks,warehouse,type,express,customer,address,customer_num,area,leibie,salesman,pinyin,fahuo,s.price,sale_state,sale_type,chuku_insert from sale s left join customerInfo c on s.customer_id=c.id) as sa left join product p on sa.product_id=p.id where convert(date,sa.riqi)>=#{ks}" +
            ...
            "like '%'+#{product}+'%' or p.pinyin like '%'+#{product}+'%') and pihao like '%'+#{pihao}+'%' and sale_type like '%'+#{saleType}+'%' and sa.chuku_insert != '1' order by sa.id desc,customer,sale_type")
    ...
    @Select("select sa.id,sa.riqi,customer_id,sh_staff,pick,product_id,sa.num,xiaoji,sa.remarks,type,customer,address,customer_num,area,leibie,salesman,product_name,spec,pinhao,attribute,unit,sa.price,p.pinyin,sa.sale_state,sa.sale_type,warehouse from (select s.id,s.riqi,customer_id,sh_staff,pick,wuliu_order,product_id,pihao,num,xiaoji,s.remarks,warehouse,type,express,customer,address,customer_num,area,leibie,salesman,pinyin,fahuo,s.price,sale_state,sale_type,chuku_insert from sale s left join customerInfo c on s.customer_id=c.id) as sa left join product p on sa.product_id=p.id where convert(date,sa.riqi)>=#{ks} and convert(date,sa.riqi)<=#{js} " +
            ...
            "like '%'+#{product}+'%') and pihao like '%'+#{pihao}+'%' and salesman=#{name} and sale_type like '%'+#{saleType}+'%' and sa.chuku_insert != '1' order by sa.id desc,customer,sale_type")
    ...
    @Select("select sum(convert(float,xiaoji)) as price from sale where sale_state = '审核通过'  and type = '销售' and riqi = #{riqi};")
